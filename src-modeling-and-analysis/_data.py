...
csv_dtypes = {'Category': str, 'Count': float, 'Genotype Position': float, 'Indel with Mismatches': str,
              'Ins Fivehomopolymer': str, 'Ins Template Length': float, 'Ins mh2': str, 'Ins p2': str,
              'Inserted Bases': str, 'Length': float, 'Microhomology-Based': str, '_ExpDir': str, '_Experiment': str,
              '_Sequence Context': str, '_Cutsite': int}

memoized = dict()

D = pd.read_csv(_config.DATA_DIR + 'DataTable.csv',
                dtype={'Name': str, 'Library': str, 'Memoization': str, 'Local_Name': str, 'Alignment_Directory': str,
                       'Data_Directory': str})

exp_subset_dict = {'vo_spacers': ['overbeek_spacer_1', 'overbeek_spacer_10', 'overbeek_spacer_11', 'overbeek_spacer_12',
                                  'overbeek_spacer_13', 'overbeek_spacer_14', 'overbeek_spacer_15',
                                  'overbeek_spacer_16', 'overbeek_spacer_17', 'overbeek_spacer_18',
                                  'overbeek_spacer_19', 'overbeek_spacer_2', 'overbeek_spacer_20', 'overbeek_spacer_21',
                                  'overbeek_spacer_22', 'overbeek_spacer_23', 'overbeek_spacer_24',
                                  'overbeek_spacer_25', 'overbeek_spacer_26', 'overbeek_spacer_27',
                                  'overbeek_spacer_28', 'overbeek_spacer_29', 'overbeek_spacer_3', 'overbeek_spacer_30',
                                  'overbeek_spacer_31', 'overbeek_spacer_32', 'overbeek_spacer_33',
                                  'overbeek_spacer_34', 'overbeek_spacer_35', 'overbeek_spacer_36',
                                  'overbeek_spacer_37', 'overbeek_spacer_38', 'overbeek_spacer_39', 'overbeek_spacer_4',
                                  'overbeek_spacer_40', 'overbeek_spacer_41', 'overbeek_spacer_42',
                                  'overbeek_spacer_43', 'overbeek_spacer_44', 'overbeek_spacer_45',
                                  'overbeek_spacer_46', 'overbeek_spacer_47', 'overbeek_spacer_48',
                                  'overbeek_spacer_49', 'overbeek_spacer_5', 'overbeek_spacer_50', 'overbeek_spacer_51',
                                  'overbeek_spacer_52', 'overbeek_spacer_53', 'overbeek_spacer_54',
                                  'overbeek_spacer_55', 'overbeek_spacer_56', 'overbeek_spacer_57',
                                  'overbeek_spacer_58', 'overbeek_spacer_59', 'overbeek_spacer_6', 'overbeek_spacer_60',
                                  'overbeek_spacer_61', 'overbeek_spacer_62', 'overbeek_spacer_63',
                                  'overbeek_spacer_64', 'overbeek_spacer_65', 'overbeek_spacer_66',
                                  'overbeek_spacer_67', 'overbeek_spacer_68', 'overbeek_spacer_69', 'overbeek_spacer_7',
                                  'overbeek_spacer_70', 'overbeek_spacer_71', 'overbeek_spacer_72',
                                  'overbeek_spacer_73', 'overbeek_spacer_74', 'overbeek_spacer_75',
                                  'overbeek_spacer_76', 'overbeek_spacer_77', 'overbeek_spacer_78',
                                  'overbeek_spacer_79', 'overbeek_spacer_8', 'overbeek_spacer_80', 'overbeek_spacer_81',
                                  'overbeek_spacer_82', 'overbeek_spacer_83', 'overbeek_spacer_84',
                                  'overbeek_spacer_85', 'overbeek_spacer_86', 'overbeek_spacer_87',
                                  'overbeek_spacer_88', 'overbeek_spacer_89', 'overbeek_spacer_9', 'overbeek_spacer_90',
                                  'overbeek_spacer_91', 'overbeek_spacer_92', 'overbeek_spacer_93',
                                  'overbeek_spacer_94', 'overbeek_spacer_95', 'overbeek_spacer_96'],
                   'longdup_series': ['longdup_7_r1', 'longdup_8_r1', 'longdup_9_r1', 'longdup_10_r1', 'longdup_11_r1',
                                      'longdup_12_r1', 'longdup_13_r1', 'longdup_14_r1', 'longdup_15_r1',
                                      'longdup_16_r1', 'longdup_17_r1', 'longdup_18_r1', 'longdup_19_r1',
                                      'longdup_20_r1', 'longdup_21_r1', 'longdup_22_r1', 'longdup_23_r1',
                                      'longdup_24_r1', 'longdup_25_r1', 'longdup_7_r2', 'longdup_8_r2', 'longdup_9_r2',
                                      'longdup_10_r2', 'longdup_11_r2', 'longdup_12_r2', 'longdup_13_r2',
                                      'longdup_14_r2', 'longdup_15_r2', 'longdup_16_r2', 'longdup_17_r2',
                                      'longdup_18_r2', 'longdup_19_r2', 'longdup_20_r2', 'longdup_21_r2',
                                      'longdup_22_r2', 'longdup_23_r2', 'longdup_24_r2', 'longdup_25_r2',
                                      'longdup_7_r3', 'longdup_8_r3', 'longdup_9_r3', 'longdup_10_r3', 'longdup_11_r3',
                                      'longdup_12_r3', 'longdup_13_r3', 'longdup_14_r3', 'longdup_15_r3',
                                      'longdup_16_r3', 'longdup_17_r3', 'longdup_18_r3', 'longdup_19_r3',
                                      'longdup_20_r3', 'longdup_21_r3', 'longdup_22_r3', 'longdup_23_r3',
                                      'longdup_24_r3', 'longdup_25_r3'],
...
def merge_l2_datasets_summation(l3_data):
    ...
    for exp in keys_superset:
        ...
        # Merge dataframes
        join_cols = ['Category', 'Genotype Position', 'Indel with Mismatches', 'Ins Fivehomopolymer',
                     'Ins Template Length', 'Ins Template Orientation', 'Ins mh2', 'Ins p2', 'Inserted Bases', 'Length',
                     'Microhomology-Based']
        for idx in range(1, len(dfs)):
            ...
            try:
                assert bool(curr_context == expected_context) and bool(
                    curr_cutsite == expected_cutsite), 'ERROR: Trying to merge two L2 datasets with different context or cutsite'
            except:
                import code;
